  ...
  <el-container>
    ...
    <el-container>.
      ...
      <el-aside width="228px" height="100%">
        <v-menu :selected1="selected" :hidden="hidden" index="order"></v-menu>
      </el-aside>
  ...
  export default {
    data(){
      return{
        selected:5,
        hidden:1,
        tableData:[{id:'MA23847223342',name:'小明',xdate:'2018-06-12 12:59:00',zdate:'正常',money:'200',type:'线下'},{id:'MA23847223342',name:'小明',xdate:'2018-06-12 12:59:00',zdate:'正常',money:'200',type:'线下'}],
        currentPage: 4,//分页第几页
        userInfo:'',//登录信息
      }
    },
